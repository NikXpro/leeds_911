...
Config.departementList = {
    ["Law Enforcement"] = {
        {Label = "LSPD", Banner = "", Texture = "mrpd", Activate = true, Coords = vector3(455.34024047852, -991.51263427734, 30.689617156982), Heading = 100},
        {Label = "LSSD", Banner = "", Texture = "vpd", Activate = true, Coords = vector3(-437.11752319336, 6020.279296875, 31.490112304688), Heading = 100},
    },
    ["Fire & Rescue"] = {
        {Label = "LSFD", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(219.51557922363, -1645.0241699219, 29.677095413208), Heading = 100},
        {Label = "LSCoFD", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(1691.7346191406, 3580.4772949219, 35.596828460693), Heading = 100},
    },
    ["Civilian"] = {
        {Label = "Los Santos County", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(1959.1683349609, 3732.5795898438, 32.226196289062), Heading = 100},
        {Label = "Los Santos City", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(-1604.7893066406, -956.60559082031, 13.016840934753), Heading = 100}
    },
}