...
Config.departementList = {
    ["Law Enforcement"] = {
        {Label = "LSPD", Type = "law_enforcement", Banner = "", Texture = "mrpd", Activate = true, Coords = vector3(455.34024047852, -991.51263427734, 30.689617156982)},
        {Label = "LSSD", Type = "law_enforcement", Banner = "", Texture = "vpd", Activate = true, Coords = vector3(-437.11752319336, 6020.279296875, 31.490112304688)},
    },
    ["Fire & Rescue"] = {
        {Label = "LSFD", Type = "fire_rescue", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(219.51557922363, -1645.0241699219, 29.677095413208)},
        {Label = "LSCoFD", Type = "fire_rescue", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(1691.7346191406, 3580.4772949219, 35.596828460693)},
    },
    ["Civilian"] = {
        {Label = "Los Santos County", Type = "civil", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(1959.1683349609, 3732.5795898438, 32.226196289062)},
        {Label = "Los Santos City", Type = "civil", Banner = "", Description = "", Texture = "mrpd", Activate = true, Coords = vector3(-1604.7893066406, -956.60559082031, 13.016840934753)}
    },
